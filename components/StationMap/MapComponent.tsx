...
//       console.log(
//         `Fetching for station ${selectedStation?.stationId} on date ${currentDate}`
//       );
//       try {
//         const res = await fetch(
//           `/api/daily-summary?stationNo=${selectedStation?.stationId}&date=${currentDate}`
//         );
...
//     fetchWeatherData();
//   }, [selectedStation, currentDate]); // Add currentDate to dependencies
