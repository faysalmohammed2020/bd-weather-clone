...
export default function DailySummaryChart() {
    ...
    const getChartTitle = () => {
        return t('chartTitle', { metric: selectedOption?.label || t('weatherData') })
    }
            ...
            <Card className="border-0 shadow-lg">
                ...
                <CardContent className="p-6">
                    <div className="flex flex-col items-center justify-center h-[400px] gap-4 text-center">
                        ...
                        <div>
                            <h3 className="text-lg font-medium">{t('errorHeading')}</h3>
    ...
    if (weatherData.length === 0) {
        return (
            <Card className="border-0 shadow-lg">
                <CardHeader className="border-b">
                    <CardTitle>{t('dashboardTitle')}</CardTitle>
                    <CardDescription>{t('noDataTitle')}</CardDescription>
                </CardHeader>
                <CardContent className="p-6">
                    <div className="flex flex-col items-center justify-center h-[400px] gap-4 text-center">
                        <IoCloudOffline className="h-12 w-12 text-gray-400" />
                        <div>
                            <h3 className="text-lg font-medium">{t('noDataHeading')}</h3>
                        ...
                        <CardDescription className="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            {weatherData.length > 0 && (
                                <span className="ml-2 text-xs bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-full">
                                    {t('recordCount', { count: weatherData.length })}
                                </span>
                            )}
                        </CardDescription>
                    </div>
