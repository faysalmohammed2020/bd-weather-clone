...
export default function MapComponent({
  ...
  return (
    <div className="relative h-[calc(100vh-100px)] w-full z-10">
      {/* Map Container */}
      <div className="relative h-[calc(100vh-100px)] w-full rounded-lg overflow-hidden border-2 border-gray-200">
        <MapContainer
          center={[31.24, 36.51]} // 🇯🇴 Updated to center on Amman, Jordan
          zoom={7}
