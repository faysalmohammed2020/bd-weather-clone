...
export async function PUT(req: Request) {
  try {
    ...
    const dataType = data.dataType ? Object.values(data.dataType).join("") : undefined;
    const stationNo = data.stationNo ? Object.values(data.stationNo).join("") : undefined;
    ...
    const updateData: any = {
      ...
      ...(data.subIndicator !== undefined && { subIndicator: data.subIndicator || "" }),
      ...(data.alteredThermometer !== undefined && { alteredThermometer: data.alteredThermometer || "" }),
      ...(data.barAsRead !== undefined && { barAsRead: data.barAsRead || "" }),
      ...(data.correctedForIndex !== undefined && { correctedForIndex: data.correctedForIndex || "" }),
      ...(data.heightDifference !== undefined && { heightDifference: data.heightDifference || "" }),
      ...(data.correctionForTemp !== undefined && { correctionForTemp: data.correctionForTemp || "" }),
      ...(data.stationLevelPressure !== undefined && { stationLevelPressure: data.stationLevelPressure || "" }),
      ...(data.seaLevelReduction !== undefined && { seaLevelReduction: data.seaLevelReduction || "" }),
      ...(data.correctedSeaLevelPressure !== undefined && { correctedSeaLevelPressure: data.correctedSeaLevelPressure || "" }),
      ...(data.afternoonReading !== undefined && { afternoonReading: data.afternoonReading || "" }),
      ...(data.pressureChange24h !== undefined && { pressureChange24h: data.pressureChange24h || "" }),
      ...(data.dryBulbAsRead !== undefined && { dryBulbAsRead: data.dryBulbAsRead || "" }),
      ...(data.wetBulbAsRead !== undefined && { wetBulbAsRead: data.wetBulbAsRead || "" }),
      ...(data.maxMinTempAsRead !== undefined && { maxMinTempAsRead: data.maxMinTempAsRead || "" }),
      ...(data.dryBulbCorrected !== undefined && { dryBulbCorrected: data.dryBulbCorrected || "" }),
      ...(data.wetBulbCorrected !== undefined && { wetBulbCorrected: data.wetBulbCorrected || "" }),
      ...(data.maxMinTempCorrected !== undefined && { maxMinTempCorrected: data.maxMinTempCorrected || "" }),
      ...(data.Td !== undefined && { Td: data.Td || "" }),
      ...(data.relativeHumidity !== undefined && { relativeHumidity: data.relativeHumidity || "" }),
      ...(data.squallConfirmed !== undefined && { squallConfirmed: String(data.squallConfirmed ?? "") }),
      ...(data.squallForce !== undefined && { squallForce: data.squallForce || "" }),
      ...(data.squallDirection !== undefined && { squallDirection: data.squallDirection || "" }),
      ...(data.squallTime !== undefined && { squallTime: data.squallTime || "" }),
      ...(data.horizontalVisibility !== undefined && { horizontalVisibility: data.horizontalVisibility || "" }),
      ...(data.miscMeteors !== undefined && { miscMeteors: data.miscMeteors || "" }),
      ...(data.pastWeatherW1 !== undefined && { pastWeatherW1: data.pastWeatherW1 || "" }),
      ...(data.pastWeatherW2 !== undefined && { pastWeatherW2: data.pastWeatherW2 || "" }),
      ...(data.presentWeatherWW !== undefined && { presentWeatherWW: data.presentWeatherWW || "" }),
      ...(data.c2Indicator !== undefined && { c2Indicator: data.c2Indicator || "" }),
      ...(data.observationTime !== undefined && { observationTime: data.observationTime || "" }),
      ...(data.timestamp !== undefined && { timestamp: data.timestamp || new Date().toISOString() }),
    };
