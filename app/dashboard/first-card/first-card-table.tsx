    ...
    <Card className="shadow-xl border-none overflow-hidden bg-gradient-to-br from-white to-slate-50">
      <CardHeader className="p-4 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex items-center gap-3">
            <CloudSun size={24} className="text-yellow-300" />
            <CardTitle className="text-xl font-bold">Meteorological Data Dashboard</CardTitle>
          </div>
      ...
      <CardContent className="p-6">
                ...
                <tbody>
                  {loading ? (
                    ...
                    filteredData.map((record, index) => {
                      ...
                      return (
                        <tr key={record.id} className="text-center font-mono hover:bg-slate-50 transition-colors">
                          <td className="border border-slate-300 p-1 font-medium text-indigo-700">
                            {time.split(":")[0] || "--"}
                          </td>
                          <td className="border border-slate-300 p-1">{record.c2Indicator || "--"}</td>
        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          <DialogContent className="max-w-4xl">
            <DialogHeader>
              <DialogTitle>Edit Meteorological Data</DialogTitle>
            </DialogHeader>

            {selectedRecord && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4 max-h-[70vh] overflow-y-auto">
                <div className="space-y-2">
                  <Label htmlFor="observationTime">Observation Time (GMT)</Label>
                  <Input
                    id="observationTime"
                    value={editFormData.observationTime || ""}
                ...
                <div className="space-y-2">
                  <Label htmlFor="c2Indicator">Indicator</Label>
                  <Input
                    id="c2Indicator"
                    value={editFormData.c2Indicator || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="alteredThermometer">Attached Thermometer (°C)</Label>
                  <Input
                    id="alteredThermometer"
                    value={editFormData.alteredThermometer || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={editFormData.correctedForIndex || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="heightDifference"
                    value={editFormData.heightDifference || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="stationLevelPressure">Station Level Pressure (QFE)</Label>
                  <Input
                    id="stationLevelPressure"
                    value={editFormData.stationLevelPressure || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={editFormData.seaLevelReduction || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="correctedSeaLevelPressure">Sea Level Pressure (QNH)</Label>
                  <Input
                    id="correctedSeaLevelPressure"
                    value={editFormData.correctedSeaLevelPressure || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="dryBulbAsRead">Dry Bulb As Read (°C)</Label>
                  <Input
                    id="dryBulbAsRead"
                    value={editFormData.dryBulbAsRead || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="wetBulbAsRead">Wet Bulb As Read (°C)</Label>
                  <Input
                    id="wetBulbAsRead"
                    value={editFormData.wetBulbAsRead || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="maxMinTempAsRead">MAX/MIN Temp As Read (°C)</Label>
                  <Input
                    id="maxMinTempAsRead"
                    value={editFormData.maxMinTempAsRead || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="dryBulbCorrected"
                    value={editFormData.dryBulbCorrected || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="wetBulbCorrected"
                    value={editFormData.wetBulbCorrected || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="Td">Dew Point Temperature (°C)</Label>
                  <Input id="Td" value={editFormData.Td || ""} onChange={handleEditInputChange} className="w-full" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="relativeHumidity"
                    value={editFormData.relativeHumidity || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={editFormData.horizontalVisibility || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="presentWeatherWW"
                    value={editFormData.presentWeatherWW || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="pastWeatherW1">Past Weather (W₁)</Label>
                  <Input
                    id="pastWeatherW1"
                    value={editFormData.pastWeatherW1 || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="pastWeatherW2">Past Weather (W₂)</Label>
                  <Input
                    id="pastWeatherW2"
                    value={editFormData.pastWeatherW2 || ""}
                    onChange={handleEditInputChange}
                    className="w-full"
                  />
                </div>
