...
import { Calendar, ChevronLeft, ChevronRight, Download, CloudSun, Filter, RefreshCw, Loader2 } from "lucide-react"
...
function canEditObservation(record: SecondCardData, sessionUser: any) {
  ...
  try {
    ...
    if (role === "observer")
      return daysDifference <= 2 && userId && record.observer?.id && userId === record.observer.id
...
export function SecondCardTable({ refreshTrigger = 0 }: SecondCardTableProps) {
  ...
  const fetchData = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to fetch weather observation data",
        variant: "destructive",
      })
    } finally {
      setLoading(false)
  ...
  const exportToCSV = () => {
    ...
    const csvRows = [
      ...
      ...filteredData.map((item) => {
        ...
        const totalCloudAmount = item.totalCloud?.["total-cloud-amount"] || "N/A"
  ...
  const handleEditInputChange = (section: keyof SecondCardData, field: string, value: string) => {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      setData((prevData) =>
        prevData.map((item) => (item.metadata.id === selectedRecord.metadata.id ? { ...item, ...editFormData } : item)),
      )

      toast({
        title: "Success",
        description: "Weather observation updated successfully",
        variant: "default",
      })
      ...
      toast({
        title: "Error",
        description: "Failed to update weather observation",
        variant: "destructive",
      })
    } finally {
      setIsSaving(false)
      ...
      <CardHeader className="p-4 bg-gradient-to-r from-sky-600 to-blue-600 text-white">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <CardTitle className="text-xl font-bold">Weather Observation Dashboard</CardTitle>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={exportToCSV} className="gap-1 bg-emerald-500 hover:bg-emerald-600 text-white" size="sm">
                ...
                <thead>
                  ...
                  <tr>
                    <th className="border border-slate-300 bg-gradient-to-b from-sky-50 to-sky-100 text-xs p-1">
                      <div className="h-16 text-sky-800">Observation / Submission</div>
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-sky-50 to-sky-100 text-xs p-1">
                ...
                <tbody>
                  {loading ? (
                    ...
                    filteredData.map((record, index) => {
                      ...
                      try {
                        // Format observation time if available
                        if (record.observer["observation-time"]) {
                          const parsedDate = parseISO(record.observer["observation-time"])
                          if (isValid(parsedDate)) {
                            time = format(parsedDate, "HH:mm")
                          }
                        }

                        // Always format submission time
                        if (record.metadata.submittedAt) {
                          const parsedSubmitDate = parseISO(record.metadata.submittedAt)
                          if (isValid(parsedSubmitDate)) {
                            submissionTime = format(parsedSubmitDate, "HH:mm")
                          }
                        }
                      } catch (e) {
                      ...
                      const totalCloudAmount = record.totalCloud?.["total-cloud-amount"] || "--"
                      ...
                      return (
                        ...
                        >
                          <td className="border border-slate-300 p-1 font-medium text-sky-700">
                            <div className="flex flex-col">
                              <span>{time}</span>
                              <span className="text-[10px] text-gray-500">Sub: {submissionTime}</span>
                            </div>
                          </td>
            ...
            {selectedRecord && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-4 max-h-[65vh] overflow-y-auto pr-2">
                ...
                <div className="space-y-1 p-3 rounded-lg bg-sky-50 border border-white shadow-sm">
                  ...
                  <Input
                    id="totalCloudAmount"
                    value={(editFormData.totalCloud?.["total-cloud-amount"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("totalCloud", "total-cloud-amount", e.target.value)}
                ...
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.clouds?.low?.direction as string) ?? ""}
                    onChange={(e) => handleEditInputChange("clouds", "low.direction", e.target.value)}
                ...
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("clouds", "low.height", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("clouds", "low.form", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("clouds", "low.amount", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                ...
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.clouds?.medium?.direction as string) ?? ""}
                    onChange={(e) => handleEditInputChange("clouds", "medium.direction", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.clouds?.medium?.height as string) ?? ""}
                    onChange={(e) => handleEditInputChange("clouds", "medium.height", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("clouds", "medium.form", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.clouds?.medium?.amount as string) ?? ""}
                    onChange={(e) => handleEditInputChange("clouds", "medium.amount", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                ...
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.clouds?.high?.direction as string) ?? ""}
                    onChange={(e) => handleEditInputChange("clouds", "high.direction", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("clouds", "high.height", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("clouds", "high.form", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("clouds", "high.amount", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
                ...
                <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.rainfall?.["time-start"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("rainfall", "time-start", e.target.value)}
                ...
                <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.rainfall?.["time-end"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("rainfall", "time-end", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.rainfall?.["since-previous"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("rainfall", "since-previous", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.rainfall?.["during-previous"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("rainfall", "during-previous", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.rainfall?.["last-24-hours"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("rainfall", "last-24-hours", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200"
                  />
                </div>
                ...
                <div className="space-y-1 p-3 rounded-lg bg-amber-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.wind?.["first-anemometer"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("wind", "first-anemometer", e.target.value)}
                ...
                <div className="space-y-1 p-3 rounded-lg bg-amber-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.wind?.["second-anemometer"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("wind", "second-anemometer", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-amber-400 focus:ring-2 focus:ring-amber-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-amber-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("wind", "speed", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-amber-400 focus:ring-2 focus:ring-amber-200"
                  />
                </div>
                <div className="space-y-1 p-3 rounded-lg bg-amber-50 border border-white shadow-sm">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleEditInputChange("wind", "direction", e.target.value)}
                    className="w-full bg-white border-gray-300 focus:border-amber-400 focus:ring-2 focus:ring-amber-200"
                  />
                </div>
                ...
                <div className="space-y-1 p-3 rounded-lg bg-gray-50 border border-white shadow-sm">
                  ...
                  <Input
                    value={(editFormData.observer?.["observer-initial"] as string) ?? ""}
                    onChange={(e) => handleEditInputChange("observer", "observer-initial", e.target.value)}
