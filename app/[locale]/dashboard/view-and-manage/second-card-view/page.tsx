...
const SecondCardTable = forwardRef(({ refreshTrigger = 0 }: SecondCardTableProps, ref) => {
  const t = useTranslations("secondCardTable")
  const [data, setData] = useState<ObservationData[]>([])
  const [loading, setLoading] = useState(true)
  const [stationFilter, setStationFilter] = useState("all")
  const [stations, setStations] = useState<{ id: string; stationId: string; name: string }[]>([])
  ...
  const handleDateChange = (type: "start" | "end", newDate: string) => {
    ...
    if (type === "start") {
      if (date > otherDate) {
        setDateError(t("errors.startDateAfterEnd"))
        return
      }
      setStartDate(newDate)
    } else {
  ...
  const exportToCSV = () => {
    ...
    const headers = [
      t("table.headers.timeUTC"),
      t("table.headers.c2Indicator"),
      t("table.headers.date"),
      t("table.headers.station"),
      t("table.headers.totalCloudAmount"),
      t("table.headers.lowCloudDirection"),
      t("table.headers.lowCloudHeight"),
      t("table.headers.lowCloudForm"),
      t("table.headers.lowCloudAmount"),
      t("table.headers.mediumCloudDirection"),
      t("table.headers.mediumCloudHeight"),
      t("table.headers.mediumCloudForm"),
      t("table.headers.mediumCloudAmount"),
      t("table.headers.highCloudDirection"),
      t("table.headers.highCloudHeight"),
      t("table.headers.highCloudForm"),
      t("table.headers.highCloudAmount"),
      t("table.headers.layer1Height"),
      t("table.headers.layer1Form"),
      t("table.headers.layer1Amount"),
      t("table.headers.layer2Height"),
      t("table.headers.layer2Form"),
      t("table.headers.layer2Amount"),
      t("table.headers.layer3Height"),
      t("table.headers.layer3Form"),
      t("table.headers.layer3Amount"),
      t("table.headers.layer4Height"),
      t("table.headers.layer4Form"),
      t("table.headers.layer4Amount"),
      t("table.headers.rainfallStartTime"),
      t("table.headers.rainfallEndTime"),
      t("table.headers.sincePrevious"),
      t("table.headers.duringPrevious"),
      t("table.headers.last24Hours"),
      t("table.headers.windFirstAnemometer"),
      t("table.headers.windSecondAnemometer"),
      t("table.headers.windSpeed"),
      t("table.headers.windDirection"),
      t("table.headers.observerInitial"),
    ]
        ...
        <div className="flex flex-col md:flex-row justify-between  gap-4 mb-4 md:mb-6 bg-slate-100 p-3 sm:p-4 rounded-lg">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-3 md:gap-2">
            ...
            <div className="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto max-w-sm md:max-w-none">
              <input
                ...
                className="text-xs sm:text-sm p-2 border border-slate-300 focus:ring-purple-500 focus:ring-2 rounded w-full xs:w-auto min-w-0"
              />
              <span className="text-sm text-slate-600 whitespace-nowrap px-1">{t("dateRange.to")}</span>
              <input
                type="date"
                value={endDate}
                onChange={(e) => handleDateChange("end", e.target.value)}
            ...
            <Button variant="outline" size="icon" onClick={goToNextWeek} className="hover:bg-slate-200 flex-shrink-0">
              <ChevronRight className="h-4 w-4" />
            </Button>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 md:gap-4 pt-3 md:pt-0 border-t md:border-t-0 border-slate-200">
            ...
            {session?.user?.role && ["super_admin", "station_admin"].includes(session?.user?.role) && (
              ...
              >
                <Download className="h-4 w-4 flex-shrink-0" />
                <span className="whitespace-nowrap">{t("actions.exportCSV")}</span>
              </Button>
            )}
              ...
              <table className="w-full border-collapse">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    >
                      {t("table.sections.significantCloud")}
                    </th>
                  ...
                  <tr>
                    <th
                      ...
                      className="border border-slate-300 bg-gradient-to-b from-blue-50 to-blue-100 p-1 text-blue-800"
                    >
                      {t("table.sections.lowCloud")}
                    </th>
                    <th
                      colSpan={4}
                      className="border border-slate-300 bg-gradient-to-b from-blue-50 to-blue-100 p-1 text-blue-800"
                    >
                      {t("table.sections.mediumCloud")}
                    </th>
                    <th
                      colSpan={3}
                      className="border border-slate-300 bg-gradient-to-b from-blue-50 to-blue-100 p-1 text-blue-800"
                    >
                      {t("table.sections.highCloud")}
                    </th>
                    ...
                    <th
                      ...
                      className="border border-slate-300 bg-gradient-to-b from-indigo-50 to-indigo-100 p-1 text-indigo-800"
                    >
                      {t("table.sections.layer1")}
                    </th>
                    <th
                      colSpan={3}
                      className="border border-slate-300 bg-gradient-to-b from-indigo-50 to-indigo-100 p-1 text-indigo-800"
                    >
                      {t("table.sections.layer2")}
                    </th>
                    <th
                      colSpan={3}
                      className="border border-slate-300 bg-gradient-to-b from-indigo-50 to-indigo-100 p-1 text-indigo-800"
                    >
                      {t("table.sections.layer3")}
                    </th>
                    <th
                      colSpan={3}
                      className="border border-slate-300 bg-gradient-to-b from-indigo-50 to-indigo-100 p-1 text-indigo-800"
                    >
                      {t("table.sections.layer4")}
                    </th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th className="border border-slate-300 bg-gradient-to-b from-blue-50 to-blue-100 text-xs p-1 text-blue-800">
                      {t("table.headers.formCode")}
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-blue-50 to-blue-100 text-xs p-1 text-blue-800">
                      {t("table.headers.amountOcta")}
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-blue-50 to-blue-100 text-xs p-1 text-blue-800">
                      {t("table.headers.directionCode")}
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-blue-50 to-blue-100 text-xs p-1 text-blue-800">
                      {t("table.headers.heightOfBaseCode")}
                    </th>
                    ...
                    <th className="border border-slate-300 bg-gradient-to-b from-emerald-50 to-emerald-100 p-1 font-medium text-emerald-800">
                      {t("table.headers.timeOfStart")}
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-emerald-50 to-emerald-100 p-1 font-medium text-emerald-800">
                      {t("table.headers.timeOfEnd")}
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-emerald-50 to-emerald-100 p-1 font-medium text-emerald-800">
                      {t("table.headers.sincePrevious")}
                    </th>
                    ...
                    <th className="border border-slate-300 bg-gradient-to-b from-amber-50 to-amber-100 p-1 font-medium text-amber-800">
                      {t("table.headers.firstAnemometerReading")}
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-amber-50 to-amber-100 p-1 font-medium text-amber-800">
                      {t("table.headers.secondAnemometerReading")}
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-amber-50 to-amber-100 p-1 font-medium text-amber-800">
                      {t("table.headers.speedKTS")}
                    </th>
                    <th className="border border-slate-300 bg-gradient-to-b from-amber-50 to-amber-100 p-1 font-medium text-amber-800">
                      {t("table.headers.direction")}
                    </th>
                  </tr>
                </thead>
                  ...
                  {loading ? (
                    <tr>
                      <td colSpan={38} className="text-center py-8">
                        <div className="flex justify-center items-center">
                          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-sky-600"></div>
                          <span className="ml-3 text-sky-600 font-medium">{t("loading")}</span>
                        </div>
                      </td>
                    </tr>
                  ) : filteredData.length === 0 ? (
                          ...
                          <td className="border border-slate-300 p-1">
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  {canEdit ? t("actions.editRecord") : t("actions.noPermission")}
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          </td>
            ...
            <DialogHeader>
              ...
              <DialogDescription className="text-slate-600">
                {t("dialog.editDescription", {
                  station: selectedRecord?.station?.name || t("dialog.unknownStation"),
                  date: selectedRecord?.utcTime
                    ? format(new Date(selectedRecord.utcTime), "MMMM d, yyyy")
                    : t("dialog.unknownDate"),
                })}
              </DialogDescription>
              <div className="h-1 w-20 rounded-full bg-gradient-to-r from-sky-400 to-blue-400 mt-2"></div>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              {selectedRecord && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-4 max-h-[65vh] overflow-y-auto pr-2">
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-sky-50 border border-white shadow-sm">
                    <Label htmlFor="totalCloudAmount" className="text-sm font-medium text-gray-700">
                      {t("form.fields.totalCloudAmount")}
                    </Label>
                    <Input
                      {...register("totalCloudAmount")}
                  ...
                  {/* Low Cloud */}
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.lowCloudDirection")}</Label>
                    <Input
                      {...register("lowCloudDirection")}
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.lowCloudHeight")}</Label>
                    <Input
                      {...register("lowCloudHeight")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.lowCloudForm")}</Label>
                    <Input
                      {...register("lowCloudForm")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.lowCloudAmount")}</Label>
                    <Input
                      {...register("lowCloudAmount")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  {/* Medium Cloud */}
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.mediumCloudDirection")}</Label>
                    <Input
                      {...register("mediumCloudDirection")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.mediumCloudHeight")}</Label>
                    <Input
                      {...register("mediumCloudHeight")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.mediumCloudForm")}</Label>
                    <Input
                      {...register("mediumCloudForm")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.mediumCloudAmount")}</Label>
                    <Input
                      {...register("mediumCloudAmount")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  {/* High Cloud */}
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.highCloudDirection")}</Label>
                    <Input
                      {...register("highCloudDirection")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.highCloudHeight")}</Label>
                    <Input
                      {...register("highCloudHeight")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.highCloudForm")}</Label>
                    <Input
                      {...register("highCloudForm")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-blue-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.highCloudAmount")}</Label>
                    <Input
                      {...register("highCloudAmount")}
                      className={`w-full bg-white border-gray-300 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 ${
                  ...
                  {/* Rainfall */}
                  <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.rainfallStartTime")}</Label>
                    <Input
                      {...register("rainfallTimeStart")}
                      className="w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200"
                    />
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.rainfallEndTime")}</Label>
                    <Input
                      {...register("rainfallTimeEnd")}
                      className="w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200"
                    />
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">
                      {t("form.fields.rainfallSincePrevious")}
                    </Label>
                    <Input
                      {...register("rainfallSincePrevious")}
                      className={`w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">
                      {t("form.fields.rainfallDuringPrevious")}
                    </Label>
                    <Input
                      {...register("rainfallDuringPrevious")}
                      className={`w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-emerald-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.rainfallLast24Hours")}</Label>
                    <Input
                      {...register("rainfallLast24Hours")}
                      className={`w-full bg-white border-gray-300 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200 ${
                  ...
                  {/* Wind */}
                  <div className="space-y-1 p-3 rounded-lg bg-amber-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.windFirstAnemometer")}</Label>
                    <Input
                      {...register("windFirstAnemometer")}
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-amber-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.windSecondAnemometer")}</Label>
                    <Input
                      {...register("windSecondAnemometer")}
                      className={`w-full bg-white border-gray-300 focus:border-amber-400 focus:ring-2 focus:ring-amber-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-amber-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.windSpeed")}</Label>
                    <Input
                      {...register("windSpeed")}
                      className={`w-full bg-white border-gray-300 focus:border-amber-400 focus:ring-2 focus:ring-amber-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-amber-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.windDirection")}</Label>
                    <Input
                      {...register("windDirection")}
                      className={`w-full bg-white border-gray-300 focus:border-amber-400 focus:ring-2 focus:ring-amber-200 ${
                  ...
                  {/* Observer */}
                  <div className="space-y-1 p-3 rounded-lg bg-gray-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.observerInitial")}</Label>
                    <Input
                      {...register("observerInitial")}
                      readOnly
                      className="w-full bg-gray-100 border-gray-300 focus:border-gray-400 focus:ring-2 focus:ring-gray-200 cursor-not-allowed"
                  ...
                  {/* Significant Clouds */}
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer1Height")}</Label>
                    <Input
                      {...register("layer1Height")}
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer1Form")}</Label>
                    <Input
                      {...register("layer1Form")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer1Amount")}</Label>
                    <Input
                      {...register("layer1Amount")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer2Height")}</Label>
                    <Input
                      {...register("layer2Height")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer2Form")}</Label>
                    <Input
                      {...register("layer2Form")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer2Amount")}</Label>
                    <Input
                      {...register("layer2Amount")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer3Height")}</Label>
                    <Input
                      {...register("layer3Height")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer3Form")}</Label>
                    <Input
                      {...register("layer3Form")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer3Amount")}</Label>
                    <Input
                      {...register("layer3Amount")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer4Height")}</Label>
                    <Input
                      {...register("layer4Height")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer4Form")}</Label>
                    <Input
                      {...register("layer4Form")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
                  ...
                  <div className="space-y-1 p-3 rounded-lg bg-indigo-50 border border-white shadow-sm">
                    <Label className="text-sm font-medium text-gray-700">{t("form.fields.layer4Amount")}</Label>
                    <Input
                      {...register("layer4Amount")}
                      className={`w-full bg-white border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 ${
        ...
        <Dialog open={isPermissionDeniedOpen} onOpenChange={setIsPermissionDeniedOpen}>
          <DialogContent className="max-w-md rounded-xl border-0 bg-white p-6 shadow-xl">
            <DialogHeader>
              <DialogTitle className="text-xl font-bold text-red-600 flex items-center gap-2">
                <AlertTriangle className="h-5 w-5" />
                {t("dialog.permissionDeniedTitle")}
              </DialogTitle>
            </DialogHeader>
            <div className="py-4">
              <p className="text-slate-700">{t("dialog.permissionDeniedMessage")}</p>
              <ul className="mt-2 list-disc pl-5 text-sm text-slate-600 space-y-1">
                <li>{t("dialog.permissionReasons.tooOld")}</li>
                <li>{t("dialog.permissionReasons.differentStation")}</li>
                <li>{t("dialog.permissionReasons.insufficientRole")}</li>
              </ul>
            </div>
            <DialogFooter>
              <Button
