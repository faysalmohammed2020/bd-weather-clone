...
const FirstCardTable = forwardRef(
  ({ refreshTrigger = 0 }: FirstCardTableProps, ref) => {
    ...
    const exportToCSV = () => {
      ...
      const headers = [
        "Time (GMT)",
        t("fields.subIndicator"),
        t("headers.date"),
        t("headers.station") + " & ID",
        t("headers.station"),
        t("fields.alteredThermometer"),
        t("fields.barAsRead"),
        t("fields.correctedForIndex"),
        t("fields.heightDifference"),
        t("fields.stationLevelPressure"),
        t("fields.seaLevelReduction"),
        t("fields.correctedSeaLevelPressure"),
        t("fields.afternoonReading"),
        t("fields.pressureChange24h"),
        t("fields.dryBulbAsRead"),
        t("fields.wetBulbAsRead"),
        t("fields.maxMinTempAsRead"),
        t("fields.dryBulbCorrected"),
        t("fields.wetBulbCorrected"),
        t("fields.maxMinTempCorrected"),
        t("fields.Td"),
        t("fields.relativeHumidity"),
        t("fields.squallForce"),
        t("fields.squallDirection"),
        t("fields.squallTime"),
        t("fields.horizontalVisibility"),
        t("fields.miscMeteors"),
        t("fields.pastWeatherW1"),
        t("fields.pastWeatherW2"),
        t("fields.presentWeatherWW"),
        t("fields.c2Indicator"),
      ];
                ...
                <table className="w-full border-collapse">
                  <thead>
                    ...
                    <tr>
                      ...
                      >
                        {t("headers.temp.asRead")}
                      </th>
                      <th
                        colSpan={3}
                        className="border border-slate-300 bg-gradient-to-b from-cyan-50 to-cyan-100 text-xs p-1 text-cyan-800 text-center"
                      >
                        {t("headers.temp.corrected")}
                      </th>
                    </tr>
                    <tr>
                      ...
                      <th className="border border-slate-300 bg-gradient-to-b from-indigo-50 to-indigo-100 text-xs p-1">
                        <div className="h-16 text-indigo-800">{t("headers.ci")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-indigo-50 to-indigo-100 text-xs p-1">
                        <div className="h-16 text-indigo-800">{t("headers.date")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-indigo-50 to-indigo-100 text-xs p-1">
                        <div className="h-16 text-indigo-800">
                          {t("headers.station")}
                      ...
                      <th className="border border-slate-300 bg-gradient-to-b from-purple-50 to-purple-100 text-xs p-1">
                        <div className="h-16 text-purple-800">
                          {t("headers.bar.thermo")}
                        </div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-purple-50 to-purple-100 text-xs p-1">
                        <div className="h-16 text-purple-800">
                          {t("headers.bar.barRead")}
                        </div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-purple-50 to-purple-100 text-xs p-1">
                        <div className="h-16 text-purple-800">
                      ...
                      <th className="border border-slate-300 bg-gradient-to-b from-purple-50 to-purple-100 text-xs p-1">
                        <div className="h-16 text-purple-800">
                          {t("headers.bar.afternoon")}
                        </div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-purple-50 to-purple-100 text-xs p-1">
                        <div className="h-16 text-purple-800">
                          {t("headers.bar.change")}
                        </div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-cyan-50 to-cyan-100 text-xs p-1">
                        <div className="h-16 text-cyan-800">{t("headers.temp.dryAsRead")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-cyan-50 to-cyan-100 text-xs p-1">
                        <div className="h-16 text-cyan-800">{t("headers.temp.wetAsRead")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-cyan-50 to-cyan-100 text-xs p-1">
                        <div className="h-16 text-cyan-800">{t("headers.temp.maxMinAsRead")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-cyan-50 to-cyan-100 text-xs p-1">
                        <div className="h-16 text-cyan-800">{t("headers.temp.dryCorrected")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-cyan-50 to-cyan-100 text-xs p-1">
                        <div className="h-16 text-cyan-800">{t("headers.temp.wetCorrected")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-cyan-50 to-cyan-100 text-xs p-1">
                        <div className="h-16 text-cyan-800">{t("headers.temp.maxMinCorrected")}</div>
                      </th>
                      ...
                      <th className="border border-slate-300 bg-gradient-to-b from-amber-50 to-amber-100 text-xs p-1">
                        <div className="h-16 text-amber-800">{t("headers.squall.force")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-amber-50 to-amber-100 text-xs p-1">
                        <div className="h-16 text-amber-800">
                          {t("headers.squall.direction")}
                        </div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-amber-50 to-amber-100 text-xs p-1">
                        <div className="h-16 text-amber-800">{t("headers.squall.time")}</div>
                      </th>
                      ...
                      <th className="border border-slate-300 bg-gradient-to-b from-emerald-50 to-emerald-100 text-xs p-1">
                        <div className="h-16 text-emerald-800">{t("headers.weather.pastW1")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-emerald-50 to-emerald-100 text-xs p-1">
                        <div className="h-16 text-emerald-800">{t("headers.weather.pastW2")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-emerald-50 to-emerald-100 text-xs p-1">
                        <div className="h-16 text-emerald-800">{t("headers.weather.presentWW")}</div>
                      </th>
                      <th className="border border-slate-300 bg-gradient-to-b from-gray-50 to-gray-100 text-xs p-1">
                        <div className="h-16 text-gray-800">{t("headers.edit")}</div>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <DialogContent className="w-[90vw] !max-w-[95vw] rounded-xl border-0 bg-gradient-to-br from-blue-50 to-indigo-50 p-6 shadow-xl">
              <DialogHeader>
                ...
                <DialogDescription className="text-slate-600">
                  {t("editSubtitle", {
                    stationName: selectedObservingTime?.station?.name || "Unknown Station",
                    stationId: selectedObservingTime?.station?.stationId || "Unknown",
                    date: selectedObservingTime?.utcTime
                      ...
                      <Form>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4 max-h-[65vh] overflow-y-auto pr-2">
                          ...
                          {[
                            {
                              id: "subIndicator",
                              label: t("fields.subIndicator"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "alteredThermometer",
                              label: t("fields.alteredThermometer"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "barAsRead",
                              label: t("fields.barAsRead"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "correctedForIndex",
                              label: t("fields.correctedForIndex"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "heightDifference",
                              label: t("fields.heightDifference"),
                              bg: "bg-indigo-50",
                              readOnly: true,
                            },
                            {
                              id: "stationLevelPressure",
                              label: t("fields.stationLevelPressure"),
                              bg: "bg-blue-50",
                              readOnly: true,
                            },
                            {
                              id: "seaLevelReduction",
                              label: t("fields.seaLevelReduction"),
                              bg: "bg-indigo-50",
                              readOnly: true,
                            },
                            {
                              id: "correctedSeaLevelPressure",
                              label: t("fields.correctedSeaLevelPressure"),
                              bg: "bg-blue-50",
                              readOnly: true,
                            },
                            {
                              id: "afternoonReading",
                              label: t("fields.afternoonReading"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "pressureChange24h",
                              label: t("fields.pressureChange24h"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "dryBulbAsRead",
                              label: t("fields.dryBulbAsRead"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "wetBulbAsRead",
                              label: t("fields.wetBulbAsRead"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "maxMinTempAsRead",
                              label: t("fields.maxMinTempAsRead"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "dryBulbCorrected",
                              label: t("fields.dryBulbCorrected"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "wetBulbCorrected",
                              label: t("fields.wetBulbCorrected"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "maxMinTempCorrected",
                              label: t("fields.maxMinTempCorrected"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                            ...
                            {
                              id: "relativeHumidity",
                              label: t("fields.relativeHumidity"),
                              bg: "bg-blue-50",
                              readOnly: true,
                            },
                            {
                              id: "squallForce",
                              label: t("fields.squallForce"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "squallDirection",
                              label: t("fields.squallDirection"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "squallTime",
                              label: t("fields.squallTime"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "horizontalVisibility",
                              label: t("fields.horizontalVisibility"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "miscMeteors",
                              label: t("fields.miscMeteors"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "pastWeatherW1",
                              label: t("fields.pastWeatherW1"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "pastWeatherW2",
                              label: t("fields.pastWeatherW2"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                            {
                              id: "presentWeatherWW",
                              label: t("fields.presentWeatherWW"),
                              bg: "bg-blue-50",
                              readOnly: false,
                            },
                            {
                              id: "c2Indicator",
                              label: t("fields.c2Indicator"),
                              bg: "bg-indigo-50",
                              readOnly: false,
                            },
                          ].map((field) => (
            ...
            <DialogContent className="max-w-md rounded-xl border-0 bg-white p-6 shadow-xl">
              ...
              <div className="py-4">
                ...
                <ul className="mt-2 list-disc pl-5 text-sm text-slate-600 space-y-1">
                  <li>{t("permissionDenied.reasons.tooOld")}</li>
                  <li>{t("permissionDenied.reasons.wrongStation")}</li>
                  <li>{t("permissionDenied.reasons.noRole")}</li>
                </ul>
              </div>
              <DialogFooter>
                <Button
